...
namespace shuttle::engine::render
{
    ...
    namespace {
            ...
            UploadedImage2D& outImage)
        {
            ...
            auto [stagingResult, stagingBuffer] =
                allocator.createAndAllocateBufferUnique(vk::BufferCreateInfo {
            ...
            if (auto cmdBeginResult = cmd.begin(vk::CommandBufferBeginInfo{
                .flags = vk::CommandBufferUsageFlagBits::eOneTimeSubmit
            }); cmdBeginResult != vk::Result::eSuccess) return cmdBeginResult;

            auto transitionImage = [&cmd, mipCount](
                vk::Image img, vk::ImageLayout oldLayout,
        ...
        vk::Result createFallbackTexture1x1(
            vk::Device device, vk::Queue transferQueue,
            vk::CommandPool transferCommandPool,
            resources::DeviceAllocator const& allocator,
        ...
        vk::ResultValue<vk::UniqueDescriptorSetLayout> createSceneDescriptorSetLayout(vk::Device device)
        {
            ...
            bindingFlags.back() = vk::DescriptorBindingFlagBits::ePartiallyBound | vk::DescriptorBindingFlagBits::eUpdateAfterBind;
        ...
        vk::ResultValue<vk::UniquePipelineLayout> createPipelineLayout(
            vk::Device device,
        ...
        vk::ResultValue<vk::UniquePipeline> createComputePipeline(
            vk::Device device,
        ...
        vk::CommandPool transferCommandPool)
    {
        ...
        auto materialSamplerResult =
            context.device.createSamplerUnique(vk::SamplerCreateInfo{
        ...
        if (auto result = createBuiltinRendererImages(
            context.device,
            transferQueue,
            transferCommandPool,
            context.allocator,
        ...
        vk::DescriptorImageInfo materialSamplerInfo{
            .sampler = *resources.materialSampler
        };

        vk::DescriptorImageInfo shadowSamplerInfo{
            .sampler = *resources.shadowSampler
        };

        vk::DescriptorImageInfo nearestSamplerInfo{
            .sampler = *resources.nearestSampler
        };

  ...
  public:
    ...
    )
    {
        ...
        descriptorImageInfos.emplace_back(
            VK_NULL_HANDLE, albedoFallbackTexture, vk::ImageLayout::eShaderReadOnlyOptimal
        );
        descriptorImageInfos.emplace_back(
            VK_NULL_HANDLE, normalFallbackTexture, vk::ImageLayout::eShaderReadOnlyOptimal
        );
        descriptorImageInfos.emplace_back(
            VK_NULL_HANDLE, ormFallbackTexture, vk::ImageLayout::eShaderReadOnlyOptimal
        );
        descriptorImageInfos.emplace_back(
            VK_NULL_HANDLE, emissionFallbackTexture, vk::ImageLayout::eShaderReadOnlyOptimal
        );
    }
    ...
    {
        descriptorImageInfos.emplace_back(
            VK_NULL_HANDLE, textureView, vk::ImageLayout::eShaderReadOnlyOptimal
        );
    }

    void
    writeDescriptors(vk::Device device, vk::DescriptorSet descriptorSet, uint32_t binding) const
    {

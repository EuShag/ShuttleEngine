...
namespace shuttle::assets::scene_compiler
{
    ...
    struct ImportedTexture
    {
        ...
        ImportedTextureSourceKind sourceKind =
            ImportedTextureSourceKind::None;
    ...
    struct ImportedAnimationChannel
    {
        ...
        ImportedInterpolationMode translationInterpolation =
            ImportedInterpolationMode::Linear;

        ImportedInterpolationMode rotationInterpolation =
            ImportedInterpolationMode::Linear;

        ImportedInterpolationMode scaleInterpolation =
            ImportedInterpolationMode::Linear;

        ImportedInterpolationMode weightInterpolation =
            ImportedInterpolationMode::Linear;

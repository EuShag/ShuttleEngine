...
namespace shuttle::assets::formats::material
{
    ...
    enum class MaterialFlags : uint32_t
    {
        ...
        [[nodiscard]]
        constexpr MaterialFlags operator|(
            MaterialFlags lhs,
            MaterialFlags rhs) noexcept
        {
    ...
    struct MaterialInfo
    {
        ...
        uint32_t occlusionTexture = InvalidTextureIndex;
        uint32_t roughnessTexture = InvalidTextureIndex;
        uint32_t metallicTexture = InvalidTextureIndex;
